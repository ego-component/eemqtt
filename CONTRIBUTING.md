...
## 1 Fork 代码
1. 访问 https://github.com/ego-component/eemqtt
...
```bash
git clone https://github.com/ego-component/eemqtt.git
cd eemqtt
git remote add upstream 'git@github.com:<your github username>/eemqtt.git'
```
...
## 6 提交 PR
访问 https://github.com/ego-component/eemqtt, 
